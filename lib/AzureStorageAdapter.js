...
var AzureStorageAdapter = exports.AzureStorageAdapter = function () {
  ...
  _createClass(AzureStorageAdapter, [{
    ...
    value: function getFileData(filename) {
      ...
      return new Promise(function (resolve, reject) {
        var writableStreamBuffer = new _streamBuffers2.default.WritableStreamBuffer({
          initialSize: 100 * 1024, // start at 100 kilobytes.
          incrementAmount: 100 * 1024 // grow by 100 kilobytes each time buffer overflows.
        });
        _this3._client.getBlobToStream(_this3._container, filename, writableStreamBuffer, function (err, blob) {
          if (err) {
            console.error(err);
            return reject(err);
          }
